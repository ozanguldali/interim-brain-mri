...
if __name__ == '__main__':
    ...
    main(transfer_learning=True, ml_model_name="svm", penalty=False, cnn_model_name="vgg16", is_pre_trained=True,
         dataset_folder="dataset", pretrain_file="82.65_PreTrained_vgg16_Adam_dataset_out", img_size=112,
